...
export default function Home() {
    ...
    return (
      <main className="min-h-screen flex flex-col items-center justify-center p-6" style={{ background: 'var(--bg)' }}>
        <div className="w-full max-w-sm text-center">
          <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-5" style={{ background: 'var(--accent)' }}>
          ...
          <p className="text-gray-400 text-sm mb-8">Trustless ETH ↔ USDC atomic swaps on Base</p>
  ...
  return (
    <main className="min-h-screen max-w-lg mx-auto p-4" style={{ background: 'var(--bg)' }}>
